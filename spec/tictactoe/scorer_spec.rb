...
describe Scorer do
  ...
  describe "#is stalemate?" do
   it "can determine if a board is a stalemate" do
      ...
      stale_board = Board.new(["X","X","O","O","O","X","X","X","O"], output)
